...
def get_args():
    ...
    config.log_name = "/home/ntuser/Data/StreetView/logs/%s_%s" % (cfg_file_name, run_time)
    config.save_dir = "/home/ntuser/Data/StreetView/logs/%s_%s" % (cfg_file_name, run_time)
    config.log_dir = "/home/ntuser/Data/StreetView/logs/%s_%s" % (cfg_file_name, run_time)
